...
export declare const enum ChartEasingOptionProps {
    Linear = "linear",
...
export type LimitLabelPositionX = 'topLeft' | 'leftBottom' | 'rightTop' | 'rightBottom';
...
//# sourceMappingURL=LineChartNativeComponent.d.ts.map